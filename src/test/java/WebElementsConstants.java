...
public class WebElementsConstants {
    ...
    public static By nickName = By.cssSelector("div[class='gekhq4-6 hnYHyk']>:nth-child(2)");
    ...
    public static By basketControl = By.cssSelector("div[class='gg-w-8 gg-d-10 gg-t-12 gg-m-24']>:nth-child(1)");
